...
from utils.camera_pyrr import Camera
...
def main():
    ...
    crate = load_texture("resources/textures/crate.jpg")
    metal = load_texture("resources/textures/metal.jpg")
    brick = load_texture("resources/textures/brick.jpg")
