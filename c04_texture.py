...
from utils.glutils import loadImage
...
def main():
    ...
    my_shader_program = ShaderProgram("shaders/c04_texture_vs.glsl", 
                                      "shaders/c04_texture_fs.glsl")
    ...
    glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, 8 * f_size, c_void_p(6 * f_size))
    glEnableVertexAttribArray(2)

    textureID = loadImage("resources/textures/container.jpg")
